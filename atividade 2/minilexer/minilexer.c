...
// cria um Token agrupando todas as informações necessárias
...
// imprime o token encontrado e atualiza os contadores
...
{
// o vetor possui espaço para 63 caracteres e o \0 no final
if (*tamanho < 63)
{
...
// enquanto não chegar no final do arquivo (EOF) ele continua
while ((caractere = fgetc(arquivo)) != EOF)
{
    ...
    // se o caractere for espaço ou tabulação, ele é ignorado
